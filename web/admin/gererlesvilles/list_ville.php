...
<body>
    ...
    <table class="table w-60">
        ...
        <?php foreach ($villes as $ville): ?>
            ...
            <td><?= $ville['lat'] ?></td>
            <td><?= $ville['lon'] ?></td>
            <td><a class="btn btn-warning" href="../edit/edit_ville.php?lign_edit=<?= intval($ville['id']) ?>">Edit</a> <a class="btn btn-danger" href="../../back/delete.php?lign_delete=<?= intval($ville['id']) ?>">Supprimer</a></td>
            </tr>
        <?php endforeach ; ?>
